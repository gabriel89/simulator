...
<head>
	...
	<title>Le Simulator</title>
	<meta name="generator" content="TextMate http://macromates.com/">
	<meta name="original-author" content="Christian Swinehart">
	<meta name="author" content="Gabriel Barina, Horia Chifor">
...
<!--script>
var that = {init:function(){dom.find('.ctrl > a').live('click', that.menuClick) return that}
</script-->
  <div id="halfviz">
    <canvas id="viewport" width="800" height="600"></canvas>
    <div id="editor">
      <div class="io">
        <div class="ctrl" id="buttonsbar"><a href="#" data-started="true" id="start_stop" class="start">start</a><a href="#" class="new" id="loadTreeData">reset</a><a href ="#" id="popup_window" data-popup-target="#log-popup" class="showlogtext">show log</a><a href="#" class="ForceInit">load init</a></div>
        <ul class="dialog"></ul>
      </div>
...
<div position="absolute" class="popup-overlay"></div>
  ...
  <script src="src/jquery.popupWindow.js"></script>
